...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ersanstone.com/blog/isparta-mezar-tasi-rehberi',
  },
  openGraph: {
...
const articleSchema = {
  ...
  description:
    'Granit mi mermer mi? Mezar taşı seçerken dikkat edilmesi gereken boyut, malzeme, fiyat ve bakım bilgileri.',
  url: 'https://ersanstone.com/blog/isparta-mezar-tasi-rehberi',
  ...
  publisher: {
    ...
    logo: {
      '@type': 'ImageObject',
      url: 'https://ersanstone.com/images/hero.webp',
    },
  },
}
...
export default function BlogPost() {
  return (
    <>
      ...
      {/* Minimal header */}
      <header className="border-b border-stone-100 py-4 px-6">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-stone-500 text-sm mb-10">
          Ersan Stone · Kasım 2024 · 6 dakika okuma
        </p>
        ...
        <div className="prose prose-stone max-w-none prose-headings:font-playfair prose-headings:text-stone-800 prose-a:text-amber-600 prose-a:no-underline hover:prose-a:underline">
          ...
          <p>
            ...
            Bu rehberde granit ile mermer arasındaki farkı, yaygın boyutları, fiyat faktörlerini ve bakım
            önerilerini açıklıyoruz.
          </p>

          <h2>Granit mi, Mermer mi?</h2>
          <p>
            Bu soruyu her gün duyuyoruz. Kısa cevap: mezar taşı için <strong>granit neredeyse her zaman daha
            iyi bir seçimdir</strong>. İşte nedeni:
          </p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>Hava koşullarına dayanıklılık</td>
                <td>Çok yüksek</td>
                <td>Orta</td>
              </tr>
              <tr>
                <td>Asit yağmuru etkisi</td>
                <td>Minimal</td>
                <td>Yüzey aşınması</td>
              </tr>
              <tr>
                <td>Renk ve parlaklık kalıcılığı</td>
                <td>10–15 yıl+</td>
                <td>5–8 yıl</td>
              </tr>
              <tr>
                <td>Yazı ve oyma kalıcılığı</td>
                <td>Uzun ömürlü</td>
                <td>Zamanla solar</td>
              </tr>
              <tr>
          ...
          <p>
            Mermer, mutfak tezgahı, banyo veya iç mekân uygulamalarında mükemmeldir — dokusu ve beyazlığı
            eşsizdir. Ancak dışarıda, doğrudan yağmur ve güneş alan bir mezarlık ortamında granit onlarca yıl
            bakım gerektirmeden ayakta kalır.
          </p>

          <h2>Standart Mezar Taşı Boyutları</h2>
          <p>
            Türkiye&apos;deki mezarlıkların büyük çoğunluğunda mezar boyutu 60–70 cm genişlik, 200–230 cm
            uzunluktur. Anıtın (dikey taşın) boyutları mezarlık yönetmeliğine göre değişir; Isparta&apos;da
            çoğu alan için üst sınır <strong>80 cm yükseklik</strong>tir.
          </p>
          <p>
            Sipariş vermeden önce mezarlık yönetiminden izin belgesi almanızı öneririz — bazı bölgelerde özel
            boyut veya renk kısıtlamaları olabilir.
          </p>

          <h2>Fiyatı Etkileyen Faktörler</h2>
          <p>
            &ldquo;Mezar taşı ne kadar?&rdquo; sorusunun tek bir cevabı yoktur. Fiyat şu unsurlara göre değişir:
          </p>
          <ul>
          ...
          <p>
            Bize ulaşın; boyutları ve isteklerinizi bildirin, aynı gün net fiyat teklifi gönderelim.
          </p>

          <h2>Bakım Önerileri</h2>
          <p>
            Granit mezar taşları düşük bakım gerektirir, ancak birkaç basit adım ömrünü uzatır:
          </p>
          <ul>
            ...
            <li>Çatlak oluştuğunda beklemeden haber verin — Ersan Stone&apos;un 5 yıllık garantisi
              malzeme kaynaklı çatlakları kapsar.</li>
          </ul>

          <h2>Neden Ersan Stone?</h2>
          <p>
            2021&apos;den bu yana Isparta, Burdur, Afyonkarahisar, Antalya, Denizli ve Konya&apos;da yüzlerce
            mezar anıtı teslim ettik. Kendi atölyemizde üretim yapıyoruz — aracı yok, fiyat şişirmesi yok.
            Tüm işlerimizde <strong>5 yıl garanti</strong> veriyoruz.
          </p>
          ...
          <div className="not-prose mt-12 p-8 bg-stone-50 border border-stone-200 text-center">
            <p className="font-playfair text-2xl font-bold text-stone-800 mb-3">
              Ücretsiz Ölçü ve Fiyat Teklifi Alın
            </p>
            <p className="text-stone-500 text-sm mb-6">
              Boyutları ve malzeme tercihini WhatsApp&apos;tan bildirin, aynı gün fiyatlandıralım.
            </p>
            <a
